...
I am an assistant professor in the School of Computer Science and Electrical Engineering at [Handong Global University](https://handong.edu/){:target="_blank"}, Korea. My research interests include developing and applying machine learning and data mining techniques to address large and complex data-driven problems. Before joining Handong, I had the privilege of studying under the guidance of [Dr. Milos Hauskrecht](https://cs.pitt.edu/~milos){:target="_blank"} and earning my PhD at the [University of Pittsburgh](https://www.cs.pitt.edu/){:target="_blank"}.
...
* Harim Kim, Chang Ha Lee, Charmgil Hong. VATMAN: Video Anomaly Transformer for Monitoring Accidents and Nefariousness. IEEE International Conference on Advanced Video and Signal-Based Surveillance (AVSS). 2024. <span class="res">[Poster](files/arx/VATMAN_AVSS2024.pdf){:target="_blank"}</span>
...
* Charmgil Hong, Milos Hauskrecht. Multivariate Conditional Anomaly Detection and Its Clinical Application. AAAI Conference on Artificial Intelligence (AAAI) Doctoral Consortium. 2015. <span class="res">[Paper](https://ojs.aaai.org/index.php/AAAI/article/view/9263){:target="_blank"}</span>
* Charmgil Hong, Iyad Batal, Milos Hauskrecht. A Generalized Mixture Framework for Multi-label Classification. SIAM International Conference on Data Mining (SDM). 2015. <span class="res">[Paper](https://epubs.siam.org/doi/10.1137/1.9781611974010.80){:target="_blank"}</span> <span class="res">[Code](https://github.com/charmgil/MLME){:target="_blank"}</span>
...
* Iyad Batal, Charmgil Hong, Milos Hauskrecht. An efficient probabilistic framework for multi-dimensional classification. ACM International Conference on Information and Knowledge Management (CIKM). 2013. <span class="res">[Paper](https://dl.acm.org/doi/10.1145/2505515.2505594){:target="_blank"}</span> <span class="res">[Code](https://github.com/charmgil/CTBN){:target="_blank"}</span>
...
* Chanju Lee, Hyungyu Choi, Charmgil Hong. Generation of Parallel Corpus for South and North Korean Languages and Its Application to Neural Machine Translation. Korea Software Congress (KSC). 2023. <span class="res">[Paper](https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE11705605){:target="_blank"}</span>
...
* Charmgil Hong, Milos Hauskrecht. Analysis of Temporal Clinical Patterns using Hidden Markov Models. ICML 2012 Workshop on Clinical Data Analysis. 2012. <span class="res">[Paper](https://people.cs.pitt.edu/~charmgil/sharepoint/papers/Poster_Hong_ICML_Clinical_2012.pdf){:target="_blank"}</span> <span class="res">[Poster](files/posters/VATMAN_AVSS2024.pdf){:target="_blank"}</span>
