...
* Jihyun Moon, Charmgil Hong. Multimodal Clinical Decision Support for Melanoma Diagnosis Using Retrieval-Augmented Generation and Vision-Language Models. IEEE International Conference on Advanced Video and Signal-Based Surveillance (AVSS). 2025.  *(to appear)*
* Dong Gun Park, Soyeon Park, Chang Ha Lee, Hyunkyoo Choi, Charmgil Hong. VIRAL: Video Indexing and Retrieval Associated to Large-Scale Contents. IEEE International Conference on Advanced Video and Signal-Based Surveillance (AVSS). 2025.  *(to appear)*
...
#### Domestic venues
* Heeseo Jeong, Dajeong Lee, Kyujin Cho, Charmgil Hong. A Large-scale BMS Data-driven Approach to Future Electric Vehicle Driving Range Prediction. Annual Symposium of KIPS (ASK) 2025. <span class="award">*Best Paper Award*</span>
* Hyewon Jeon, Charmgil Hong. Bayesian Additive Trees for Electric Vehicle Range Prediction and Performance Evaluation. Annual Symposium of KIPS (ASK) 2025.
* Nita Li, Seyha Heng, Lay Seng, Jihyun Moon, Sokkhey Phauk, Charmgil Hong. Development of a Privacy-Focused Khmer Chatbot Based on Retrieval-Augmented Generation. Annual Symposium of KIPS (ASK) 2025.
