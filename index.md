...
* Charmgil Hong, Iyad Batal, Milos Hauskrecht. A Generalized Mixture Framework for Multi-label Classification. SIAM International Conference on Data Mining (SDM). 2015. <span class="res">[Paper](https://epubs.siam.org/doi/10.1137/1.9781611974010.80){:target="_blank"}</span>
* Charmgil Hong, Iyad Batal, Milos Hauskrecht. A Mixtures-of-Trees Framework for Multi-Label Classification. ACM International Conference on Information and Knowledge Management (CIKM). 2014. <span class="res">[Paper](https://dl.acm.org/doi/10.1145/2661829.2661989){:target="_blank"}</span>
